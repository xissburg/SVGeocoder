h1. SVGeocoder for iOS 5

SVGeocoder fills the lack of a forward geocoding class on iOS, and is an improved alternative to Apple's unreliable @MKReverseGeocoder@. It uses iOS 5's ARC, NSJSONSerializer (thanks "aufflick":https://github.com/aufflick) as well as the "Google Geocoding API":http://code.google.com/apis/maps/documentation/geocoding/ as its data provider so make sure you read their "Terms of Service":http://code.google.com/apis/maps/terms.html#section_10_12 before using SVGeocoder. 
